module AtomicLti
  class ErrorHandlingMiddleware
    ...
    def call(env)
      ...
      render_error(env, 401, "Invalid LTI launch. Please launch the application again. #{e.message}")
      ...
      render_error(env, 500, "Invalid LTI launch. Please launch the application again. #{e.message}")
    end
  end
end
