module AtomicLti::LtiAdvantage
  class Authorization
    ...
    def self.validate_token(token)
      ...
      platform = AtomicLti::Platform.find_by(iss: iss)
      if !platform
        raise AtomicLti::LtiAdvantage::Exceptions::NoLTIPlatform, "No LTI Platform found for iss #{iss}"
      end
    ...
    def self.request_token_uncached(lti_deployment)
      ...
      raise LtiAdvantage::Exceptions::OAuthError if !result.success?
